...
const Sidebar = () => {
  ...
  return(
    <aside class="flex flex-col w-64 h-100 px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
      ...
      <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          >
            ...
            <span class="mx-4 font-medium">Dataset</span>
          </a>
          ...
          >
            ...
            <span class="mx-4 font-medium">Tipe Data</span>
          </a>
